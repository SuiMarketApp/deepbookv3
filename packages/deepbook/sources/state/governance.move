...
const MIN_TAKER_STABLE: u64 = 0; // 0.1 basis points
const MAX_TAKER_STABLE: u64 = 0; // 1 basis points
const MIN_MAKER_STABLE: u64 = 0;
const MAX_MAKER_STABLE: u64 = 0; // 0.5 basis points
const MIN_TAKER_VOLATILE: u64 = 0; // 1 basis points
const MAX_TAKER_VOLATILE: u64 = 0; // 10 basis points
const MIN_MAKER_VOLATILE: u64 = 0;
const MAX_MAKER_VOLATILE: u64 = 0; // 5 basis points
